    ...
    return <SC.FooterContainer>
        ...
        <SC.FooterMenu>
            ...
            <Modal active={modalActive} setActive={setModalActive}>
                <SC.TeamWrapper>
                    <SC.TeamCard>
                        <SC.TeamLink href="https://github.com/gradussus" target="_blank" rel="noreferrer">
                            <SC.TeamImage src={vitaliiUrl} loading="lazy" alt="Vitalii"/>
                            <SC.TeamName>Vitalii</SC.TeamName>
                            <SC.TeamRole>Team Lead</SC.TeamRole>
                        </SC.TeamLink>
                    </SC.TeamCard>
                    <SC.TeamCard>
                        <SC.TeamLink href="https://github.com/LenaK513" target="_blank" rel="noreferrer">
                            <SC.TeamImage src={olenaUrl} loading="lazy" alt="Olena"/>
                            <SC.TeamName>Olena</SC.TeamName>
                            <SC.TeamRole>Scrum Master</SC.TeamRole>
                        </SC.TeamLink>
                    </SC.TeamCard>
                    <SC.TeamCard>
                        <SC.TeamLink href="https://github.com/IvanBlazhko" target="_blank" rel="noreferrer">
                    ...
                    <SC.TeamCard>
                        <SC.TeamLink href="https://github.com/Ghozzty" target="_blank" rel="noreferrer">
                    ...
                    <SC.TeamCard>
                        <SC.TeamLink href="https://github.com/Natali2721" target="_blank" rel="noreferrer">
                            <SC.TeamImage src={nataliUrl} loading="lazy" alt="Natali"/>
                            <SC.TeamName>Natali</SC.TeamName>
                            <SC.TeamRole>Developer</SC.TeamRole>
                        </SC.TeamLink>
                    </SC.TeamCard>
                    <SC.TeamCard>
                        <SC.TeamLink href="https://github.com/Slapchenko" target="_blank" rel="noreferrer">
                    ...
                    <SC.TeamCard>
                        <SC.TeamLink href="https://github.com/AlexCheverda" target="_blank" rel="noreferrer">
                    ...
                    <SC.TeamCard>
                        <SC.TeamLink href="https://github.com/andrii-pozniak" target="_blank" rel="noreferrer">
                    ...
                    <SC.TeamCard>
                        <SC.TeamLink href="https://github.com/Albertukraine" target="_blank" rel="noreferrer">
                    ...
                    <SC.TeamCard>
                        <SC.TeamLink href="https://github.com/darinacat87" target="_blank" rel="noreferrer">
                    ...
                    <SC.TeamCard>
                        <SC.TeamLink href="https://github.com/maksnovakov" target="_blank" rel="noreferrer">
                    ...
                    <SC.TeamCard>
                        <SC.TeamLink href="https://github.com/MykolaPom" target="_blank" rel="noreferrer">
